...
f1_HH_out <- f1_HH_plasticity[,c(1,3,6,7,9,12,13)]
colnames(f1_HH_out) <- c("gene", "log2FoldChange_HHHHvsAAHH_F1", "pval_HHHHvsAAHH_F1",
                                "padj_HHHHvsAAHH_F1", "log2FoldChange_HHHHvsAAAA_F1", "pval_HHHHvsAAAA_F1",
                                "padj_HHHHvsAAAA_F1")

f2_HH_out <- f2_HH_plasticity[,c(1,3,6,7,9,12,13)]
colnames(f2_HH_out) <- c("gene", "log2FoldChange_HHHHvsAAHH_F2", "pval_HHHHvsAAHH_F2",
                                "padj_HHHHvsAAHH_F2", "log2FoldChange_HHHHvsAAAA_F2", "pval_HHHHvsAAAA_F2",
                                "padj_HHHHvsAAAA_F2")

f3_HH_out <- (f3_HH_plasticity[,c(1,3,6,7,9,12,13)])
colnames(f3_HH_out) <- c("gene", "log2FoldChange_HHHHvsAAHH_F3", "pval_HHHHvsAAHH_F3",
                                "padj_HHHHvsAAHH_F3", "log2FoldChange_HHHHvsAAAA_F3", "pval_HHHHvsAAAA_F3",
                                "padj_HHHHvsAAAA_F3")

f1_AA_out <- (f1_AA_plasticity[,c(1,3,6,7,9,12,13)])
colnames(f1_AA_out) <- c("gene", "log2FoldChange_AAAAvsHHAA_F1", "pval_AAAAvsHHAA_F1",
                                "padj_AAAAvsHHAA_F1", "log2FoldChange_AAAAvsHHHH_F1", "pval_AAAAvsHHHH_F1",
                                "padj_AAAAvsHHHH_F1")

f2_AA_out <- (f2_AA_plasticity[,c(1,3,6,7,9,12,13)])
colnames(f2_AA_out) <- c("gene", "log2FoldChange_AAAAvsHHAA_F2", "pval_AAAAvsHHAAF2",
                                "padj_AAAAvsHHAA_F2", "log2FoldChange_AAAAvsHHHH_F2", "pval_AAAAvsHHHH_F2",
                                "padj_AAAAvsHHHH_F2")

f3_AA_out <- (f3_AA_plasticity[,c(1,3,6,7,9,12,13)])
colnames(f3_AA_out) <- c("gene", "log2FoldChange_AAAAvsHHAA_F3", "pval_AAAAvsHHAA_F3",
                                "padj_AAAAvsHHAA_F3", "log2FoldChange_AAAAvsHHHH_F3", "pval_AAAAvsHHHH_F3",
                                "padj_AAAAvsHHHH_F3")
