...
#make empty array
num_lines = sum(1 for line in open('/users/r/b/rbrennan/reciprocal_t/analysis/snp_loadings_go.txt'))-1

go_df = np.empty(shape=(num_lines,2), dtype = object)

i=0 # start counter

with open('/users/r/b/rbrennan/reciprocal_t/analysis/snp_loadings_go.txt') as master_file:
...
np.savetxt('/users/r/b/rbrennan/reciprocal_t/analysis/snp_GOterms.out', go_df,fmt='%5s', delimiter='\t')


## dge loadings

#make empty array
num_lines = sum(1 for line in open('/users/r/b/rbrennan/reciprocal_t/analysis/dge_loadings.txt'))-1
...
np.savetxt('/users/r/b/rbrennan/reciprocal_t/analysis/dge_GOterms.out', go_df,fmt='%5s', delimiter='\t')
